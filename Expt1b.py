...
if __name__=='__main__':
  ...
  testloader = dl.load_GaborTester(path='./gabors/', gabor_type=1)


  for alpha in np.arange(0,101,25):
    outs = score_all_nets(net, f'./data/Figure 2/Models/alpha{alpha}', [None, [0],[1],[0,1]], testloader,
                          epochs_trained=10,
                          seeds=10)
    np.save(f'./data/Figure 2/Results_alpha{alpha}.npy',outs,allow_pickle=True)
